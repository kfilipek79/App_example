# READ
isocodes <- fread("/home/kamil/Dokumenty/Data_Science/Shiny/Eurostat/Bezrobocie/iso_3166_2_countries.csv", sep = ",", select = c("ISO 3166-1 2 Letter Code", "Common Name"), data.table = F)
rawdata <- fread("/home/kamil/Dokumenty/Data_Science/Shiny/Eurostat/Bezrobocie/tipsun20.tsv", header = T, sep="\t", colClasses = "character", na.strings = ":", data.table = F)
colnames(isocodes)[1] <- "isocode"
